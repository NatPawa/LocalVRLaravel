...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    submitForm: function submitForm() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post('/login', formData).then(function (res) {
        console.log(res);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.formFields.email]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [_hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "password",
    name: "id",
    "class": "form-control",
    id: "title",
    ...
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return $data.formFields.pass = $event;
    })
  }, null, 512
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.formFields.pass]])]), _hoisted_6], 32
  /* HYDRATE_EVENTS */
  )])]);
}
